...
**Note**. If you need to install a copy of the Ruby Version Manager for Mac, follow this [link](https://www.google.com/chrome/browser/desktop/index.html){:target="_blank"}.
